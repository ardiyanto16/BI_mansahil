...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="fa fa-file-archive-o kv-caption-icon"></i>';
            ...
            self.defaults = {
                ...
                previewSettings: {
                    ...
                    html: {width: "465px", height: "170px"},
                    text: {width: "465px", height: "170px"},
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fa fa-toggle-left"></i>',
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        browseLabel: 'Pilih Data',
        removeLabel: 'Reset',
        removeTitle: 'Hapus data yang telah dipilih',
        cancelLabel: 'Cancel',
        ...
        dropZoneTitle: 'Silahkan Tarik Data dan Letakkan Disini &hellip;',
        dropZoneClickTitle: '<br>(or click to select {files})',
        previewZoomButtonTitles: {
            prev: 'View previous file',
            next: 'View next file',
            toggleheader: 'Hilangkan Header',
            fullscreen: 'Tampilkan Halaman Penuh',
            borderless: 'Tampilkan Tanpa Border',
            close: 'Tutup Detail Data'
        }
    };
