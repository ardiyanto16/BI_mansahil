  ...
  <div class="col-md-12">
    <div class="card2">
      <div class="card-header3">
        Visualisasi Perkembangan Fasilitas terhadap Prestasi
      </div>
    </div>
  </div>
  ...
  <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          Visualisasi Perkembangan Fasilitas
        </div>
        <div class="card-body">
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Fasilitas Tahunan'
    },
    subtitle: {
        text: 'Click untuk melakukan drilldown data per Fasilitas'
    },
    xAxis: {
        type: 'category'
    },
    ...
    series: [{
        ...
        $row=$data->getDataFasilitasPerTahun();
        foreach($row as $m){
        ?>
        {
            name: '<?php echo $m['year'];?>',
            y: <?php echo $m['JumlahF'];?>,
    ...
    drilldown: {
        series: [<?php $yy=$data->getFasilitasYears();
        foreach($yy as $y){
          $year=$y['year'];
        ?>{
            name: '<?php echo $year;?>',
            id: '<?php echo $year;?>',
            data: [
            <?php $dt=$data->getDataFasilitasByYears($year);
            foreach($dt as $d){
            ?>
                [
...
Highcharts.chart('containerrrr', {
    ...
    subtitle: {
        text: 'Click untuk melakukan drilldown data per triwulan'
    },
    xAxis: {
        type: 'category'
    },
...
<div class="row">
  <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          Visualisasi Perkembangan Fasilitas, Capaian Prestasi
        </div>
        <div class="card-body">
...
Highcharts.chart('containerrrrrr', {
    ...
    series: [{
        ...
        type: 'spline',
        yAxis: 1,
        <?php $combofs=$data->comboFasilitas(); ?>
        data: [<?php foreach($combofs as $cd){ echo $cd['JumlahF']; ?>,<?php }?>],
        tooltip: {
            valueSuffix: ''
        },
